...
const App = () => {
  const [data, setData] = useState<DashboardData>({ total: 0, online: 0, offline: 0, clients: [] });
    ...
    <div className="min-h-screen p-8 text-white">
      ...
      <div className="flex justify-between items-center mb-10">
        ...
        <div className="flex gap-4">
          ...
          >
            <RefreshCcw size={18} /> Refresh All
          </button>
          <button 
      ...
      <div className="space-y-6">
        ...
        <section>
          <h2 className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-3 flex items-center gap-2">
            <ShieldCheck size={14} className="text-emerald-400" /> Control Center
          </h2>
          ...
          <GlassCard>
            {selectedClient ? (
              ...
              <div className="text-[10px] text-slate-500 py-2 italic text-center">
                Select a node to authorize actions
              </div>
            )}
          </GlassCard>
        </section>
